            ...
            with st.expander('Soft & Other Skills'):
                ...
                <ul>
                    <li><b>Language Proficiencies</b>
                        <ul>
                            <li> English (Limited Proficiency) - <a href="https://drive.google.com/file/d/1Z5XtuEw0SWzCDLaXZ3pb-CrO6EEF5wl_/view?usp=sharing">TOEFL ITP Score</a></li>
                            <li> Indonesia (Native Proficiency) </li>
                        </ul>
                    </li>
                    <li><b>Other Skills</b>
                        <ul>
...
with st.container():
    ...
    with col_left:
        with st.expander('Data Analyst Intern - PT Kimia Farma (Nov 2022 - Jan 2023)', expanded=True):
            ...
            st.markdown("""
                        → Analyzed of PT Kimia Farma's overall revenue, revenue generated by each branch of the organization,and
                        the number of items sold during specific periods.      
                        """, unsafe_allow_html=True)
    ...
    with col_mid:
        with st.expander('Data Analyst Intern - Ditusi Gaming (Jun - Aug 2023)', expanded=True):
            ...
            st.subheader('Main Task', divider='gray')
            st.markdown("""
                        ○ Analyzed the top 10 popular content & the effectiveness per month of content on their social media
                        platforms based on Engagement Rate Reach (ERR) and Engagement Rate Post (ERP), reach, likes, new
                        followers, total profile visits, shares, and comments.
    ...
    with col_right:
        with st.expander('Data Scientist Intern - Kalbe Nutritional (Jun - Aug 2023)', expanded=True):
            ...
            st.markdown("""
                        ...
                        ○ Designed a Tableau dashboard to visualize monthly total quantity, daily total revenue, the number of 
...
with st.container():
    ...
    with st.expander('Analysis Premier League 2022/23 and Predict Match Result Premier League 2023/24 (Streamlit)', expanded=True):
        ...
        with col_exp:
            ...
            st.markdown("""
                        ...
                        <li>
                            Predicted match results for the upcoming 2023/2024 season using a CatBoost Classifier model with 88% balanced accuracy on train set and 83% on test set.
                        </li>
                        <li>
    ...
    with st.expander('Dashboard Tingkat Kemiskinan Jawa Barat (Streamlit)', expanded=True):
        ...
        with col_exp:
            ...
            st.markdown("""
                        <li>
                            Analyzed and suggested "Tingkat Kemiskinan" in Jawa Barat over 2017-2022, including comparison poverty per each city/regency, indeks pendidikan, indeks pembangunan manusia, etc.  
                        </li>
                        <li>
                            Analyzed and suggested IPM (Indeks Pembangunan Manusia) for each components, such as "Usia Harapan Hidup", "Harapan Lama Sekolah", and "Rata-Rata Lama Sekolah".
                        </li>
                        <li>
                            Analyzed and suggested IHK (Indeks Harga Konsumen) Trend over 2020-2024.
                        </li>
                        <li>
                            Analyzed and suggested "Tingkat Angkatan Kerja" and "Proporsi Jenis Pekerja Berdasarkan Jenis Kelamin".
                        </li>
                        <li>
                            Dataset: Collect and cleaned the dataset from BPS Jabar official website (<a href="https://jabar.bps.go.id/">Website BPS Jabar</a>)
                        </li>
                        <li>
                            <b>Related Links: </b>
